    ...
    <section id="pricing" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-center">
                  ...
                  10 AI-generated episode summaries
                </li>
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
              ...
              <Button className="w-full bg-indigo-600 hover:bg-indigo-700 text-white mt-6">
                Start Monthly Plan
              </Button>
            </CardContent>
          </Card>
          ...
          {/* One-time Payment */}
          <Card className="border-2 border-indigo-300 hover:border-indigo-400 transition-all duration-300 relative">
            ...
            <CardHeader className="text-center pb-6">
              ...
              <div className="text-4xl font-bold text-indigo-600 mt-4">£39.99</div>
            ...
            <CardContent className="space-y-4">
              ...
              <ul className="space-y-3">
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                  25 AI-generated episode summaries
                </li>
                <li className="flex items-center">
                  <span className="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                  Voice-preserved audio clips
